...
void FusionJobsTest::columnShowsValueStraightAfterPublication()
{
    ...
    // sample of the golden roll channel (0.27408954178245065 deg as of the
    // Phase 4 capture; one decimal is what the logbook shows for an angle).
    ...
    QVERIFY(qAbs(expectedRoll - 0.27408954178245065) < 1e-15);
