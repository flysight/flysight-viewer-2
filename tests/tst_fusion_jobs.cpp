...
void FusionJobsTest::columnShowsValueStraightAfterPublication()
{
    ...
    // sample of the golden roll channel (0.2740895420241314 deg as of the
    // Phase 3 capture; one decimal is what the logbook shows for an angle).
    ...
    QVERIFY(qAbs(expectedRoll - 0.2740895420241314) < 1e-15);
