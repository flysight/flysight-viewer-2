...
- **Portable mode** (default; CI on every platform, other compilers): exact
  ...
  under `stopping`), and every string, bool and null; for every other number
